...
router.put('/:representationId', requireAuth, async (req, res) => {
    try {
        const agentId = req.user?.userId;
        ...
        const updatedRepresentation = await RepresentationService.updateRepresentation(repId, updates, new ObjectId(agentId));
...
router.delete('/:representationId', requireAuth, async (req, res) => {
    try {
        const agentId = req.user?.userId;
        const representationId = req.params.representationId;
        if (!agentId) {
