...
const navigation = [
  ...
  { name: "Notes & Feedback", href: "/client/notes", icon: FileText },
  ...
  const UserIdentifier = () => (
    <div className="p-4">
      <button
        ...
        className="w-full flex items-center px-3 py-2 bg-primary/20 cursor-pointer text-sm text-gray-600 hover:bg-primary/40 hover:text-white rounded-md group relative"
        title={user?.username}
      >
    ...
    <div className="flex min-h-screen bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-[#F8FAFC] border-b md:hidden">
        <div className="flex h-16 items-center justify-between px-4">
          <h1 className="text-[#6941C6] font-bold text-xl">Talent<span className="text-[#E879F9]">Flow</span></h1>
          <button
