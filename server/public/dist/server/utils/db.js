...
export async function getCollection(collectionName) {
    ...
    return new MonitoredCollection(collection, db);
}
...
export function getWhitelistedEmailsCollection() {
    return getCollection('whitelistedEmails');
}
...
export function getRepresentationsCollection() {
    return getCollection('representations');
}
...
export function getRepresentationEventsCollection() {
    return getCollection('representationEvents');
}
