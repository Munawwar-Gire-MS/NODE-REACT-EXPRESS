...
import { CalendarEvent } from '../../shared/schema.js';
...
export class CalendarService {
   ...
   * Get an event by ID
   */
  static async getEventById(eventId: ObjectId): Promise<CalendarEvent | null> {
    const calendarCollection = await getCalendarCollection();
   ...
   */
  static async getEventsForCalendar(
    userId: ObjectId,
    ownerId: ObjectId,
    startDate: string,
    endDate: string,
    ...
    const query: Filter<CalendarEvent> = {
      ownerId,
      status: 'active',
      $or: [
   ...
   */
  static async deleteEvent(eventId: ObjectId): Promise<void> {
    const calendarCollection = await getCalendarCollection();
   ...
   */
  static async hardDeleteEvent(eventId: ObjectId): Promise<void> {
    const calendarCollection = await getCalendarCollection();
